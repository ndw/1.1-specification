<p:library xmlns:p="http://www.w3.org/ns/xproc"
   ...
   <p:declare-step type="p:add-attribute" xml:id="add-attribute">
      ...
      <p:option name="match" as="p:XSLTSelectionPattern" select="'/*'"/>
      <p:option name="attribute-name" required="true" as="p:QName"/>
   ...
   <p:declare-step type="p:compare" xml:id="compare">
      ...
      <p:option name="parameters" as="xs:string"/>
      <p:option name="method" as="p:QName?"/>
   ...
   <p:declare-step type="p:delete" xml:id="delete">
      <p:input port="source" content-types="application/xml text/xml */*+xml"/>
      <p:output port="result" content-types="application/xml"/>
      <p:option name="match" required="true" as="p:XSLTSelectionPattern"/>
   </p:declare-step>
   <p:declare-step type="p:directory-list" xml:id="directory-list">
      ...
      <p:option name="include-filter" as="p:RegularExpression*"/>
      <p:option name="exclude-filter" as="p:RegularExpression*"/>
   </p:declare-step>
   <p:declare-step type="p:error" xml:id="error">
      ...
      <p:output port="result"
                sequence="true"
                content-types="application/xml text/xml */*+xml text/*"/>
      <p:option name="code" required="true" as="p:QName"/>
   ...
   <p:declare-step type="p:filter" xml:id="filter">
      ...
      <p:option name="select" required="true" as="p:XPathExpression"/>
   </p:declare-step>
   <p:declare-step type="p:hash" xml:id="hash">
      ...
      <p:option name="algorithm" required="true" as="p:QName"/>
      <p:option name="match" as="p:XSLTSelectionPattern" select="'/*'"/>
   ...
   <p:declare-step type="p:label-elements" xml:id="label-elements">
      <p:input port="source" content-types="application/xml text/xml */*+xml"/>
      <p:output port="result" content-types="application/xml"/>
      <p:option name="attribute" as="p:QName" select="'xml:id'"/>
      <p:option name="attribute-prefix" as="xs:NCName?"/>
      <p:option name="attribute-namespace" as="xs:anyURI?"/>
      <p:option name="label" as="p:XPathExpression" select="'concat(&#34;_&#34;,$p:index)'"/>
      <p:option name="match" as="p:XSLTSelectionPattern" select="'*'"/>
   ...
   <p:declare-step type="p:pack" xml:id="pack">
      ...
      <p:option name="wrapper" required="true" as="p:QName"/>
   ...
   <p:declare-step type="p:rename" xml:id="rename">
      ...
      <p:output port="result" content-types="application/xml"/>
      <p:option name="match" as="p:XSLTSelectionPattern" select="'/*'"/>
      <p:option name="new-name" required="true" as="p:QName"/>
   ...
   <p:declare-step type="p:split-sequence" xml:id="split-sequence">
      ...
      <p:option name="test" required="true" as="p:XPathExpression"/>
   </p:declare-step>
   ...
   <p:declare-step type="p:string-replace" xml:id="string-replace">
      ...
      <p:output port="result" content-types="application/xml"/>
      <p:option name="match" required="true" as="p:XSLTSelectionPattern"/>
      <p:option name="replace" required="true" as="p:XPathExpression"/>
   </p:declare-step>
   ...
   <p:declare-step type="p:wrap-sequence" xml:id="wrap-sequence">
      ...
      <p:option name="wrapper-prefix" as="xs:NCName?"/>
      <p:option name="wrapper-namespace" as="xs:anyURI?"/>
      <p:option name="group-adjacent" as="p:XPathExpression?"/>
   </p:declare-step>
   ...
   <p:declare-step type="p:xslt" xml:id="xslt">
      ...
      <p:option name="parameters" as="xs:string"/>
      <p:option name="initial-mode" as="p:QName?"/>
      <p:option name="template-name" as="p:QName?"/>
